  ...
  return (
    <div>
      ...
      <div className="admin-kpi-grid">
        ...
        <div className="admin-kpi-card" style={{ "--kpi-color": "#B83280" }}><div className="admin-kpi-card__value">{stats.banners}</div><div className="admin-kpi-card__label">Active Banners</div></div>
