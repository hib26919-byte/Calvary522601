...
export default function ChildrensMinistryPage() {
  ...
  return (
    <main>
      <InnerPageHero
        eyebrow={language === "te" ? "పిల్లల సేవ" : "Children's Care"}
        title={t(childrensPage, "heroTitle") || (language === "te" ? "పిల్లల పరిచర్య" : "Children's Ministry")}
        subtitle={t(childrensPage, "heroSubtitle") || (language === "te" ? "దేవుని ప్రేమలో పిల్లల హృదయాలను పెంపొందించడం." : "Nurturing young hearts in the love and word of God.")}
        images={childrensPage?.heroImages}
        fallbackImage={childrensPage?.heroImageURL || DEFAULT_IMAGES.children}
